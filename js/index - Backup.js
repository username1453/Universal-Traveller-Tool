...
function planetaryfeatures(feature, layer) {
    ...
    "<p>" + "Universal World Profile: " + feature.properties.UWP + "</p>" +   // UWP of planet
...
var overlayMaps = {
    "Political Boundaries": politicalboundariesvar,
    "Planetary Data": planetarydatavar,
    "Background": backgroundtilelayer,
    "Zones": zoneCirclesLayer // Use the group containing all zone circles
};
...
legend.onAdd = function () {
    ...
    div.innerHTML += '<i style="background: red"></i><span>Markers</span><br>';
    div.innerHTML += '<i style="background: yellow"></i><span>Zone A</span><br>';
    div.innerHTML += '<i style="background: red"></i><span>Zone R</span><br>';
    return div;
};
